...
public class VehicleBean implements Serializable{
    ...
    public List<SelectItem> getTipos() {
        if (tipos == null) {
            ...
            tipos.add(new SelectItem("Camioneta"));
            tipos.add(new SelectItem("Camión Con Carrocería Volco (Volqueta)"));
            tipos.add(new SelectItem("Camión Con Carrocería Estacas"));
            tipos.add(new SelectItem("Camión Con Carrocería Furgón"));
            tipos.add(new SelectItem("Picó"));
            tipos.add(new SelectItem("Planchón"));
            tipos.add(new SelectItem("Portacontenedor"));
            tipos.add(new SelectItem("Recolector"));
            tipos.add(new SelectItem("Reparto"));
            tipos.add(new SelectItem("Tractocamión"));
        }
        return tipos;
    }

    public void setTipos(List<SelectItem> type) {
        this.tipos = type;
    }
    ...
    public void addVehicle(ActionEvent actionEvent) {
        ...
        try {
            vehicleVo.setIdDriver(2);
            vehicleVo.setIdPoint(2);
            vehicleVo.setManufacturer("Cat");
            vehicleVo.setModel("2008");
            vehicleVo.setPlateLetters("SLJ");
            vehicleVo.setPlateNumber(488);
            vehicleVo.setStatus("Libre");
            vehicleVo.setType("Pick-Up");

            vehicleFacade.persist(vehicleVo);
        } catch (ConstraintViolationException e) {
            System.out.println("********************************** Inicio de las violaciones");
            System.out.println(e.getConstraintViolations());
            System.out.println("********************************** Fin de las violaciones");
        }
