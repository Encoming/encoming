...
-- -----------------------------------------------------
-- Table `encoming`.`Worker`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `encoming`.`Worker` (
  `idWorker` INT(11) NOT NULL ,
  `salary` DOUBLE NOT NULL ,
  `person` INT(10) UNSIGNED NOT NULL ,
  PRIMARY KEY (`idWorker`) ,
  INDEX `fk_Worker_Person1_idx` (`person` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `encoming`.`Administrator` (
  ...
  INDEX `fk_Administrator_Worker1_idx` (`worker` ASC) ,
  CONSTRAINT `fk_Administrator_Worker1`
    FOREIGN KEY (`worker` )
    REFERENCES `encoming`.`Worker` (`idWorker` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
...
CREATE  TABLE IF NOT EXISTS `encoming`.`Driver` (
  ...
  INDEX `fk_Conductor_Worker1_idx` (`worker` ASC) ,
  CONSTRAINT `fk_Conductor_Worker1`
    FOREIGN KEY (`worker` )
    REFERENCES `encoming`.`Worker` (`idWorker` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
